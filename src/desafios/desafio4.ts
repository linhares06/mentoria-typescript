...
async function procurarFilme(query: string):  Promise<Movie[]> {
...
async function adicionarFilmeNaLista(filmeId: string, listaId: []) {
  let result = await HttpClient.get({
